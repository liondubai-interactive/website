    ...
    >
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            harass users or submit unlawful, deceptive, or harmful content;
          </li>
          <li>
            interfere with the service, reverse engineer protected services, or
            access another person&apos;s account without permission; or
          </li>
          <li>
            use the app in a way that violates third-party terms or applicable
            law.
          </li>
        </ul>
        <p>
