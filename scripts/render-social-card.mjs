...
try {
  ...
  await expect(page.locator(".hero-visual model-viewer")).toHaveCSS("opacity", "1");
  ...
  // Older messenger previews may still request the original, unversioned URL.
  await copyFile(new URL("../public/og-v5.png", import.meta.url), new URL("../public/og.png", import.meta.url));
} finally {
  await browser.close();
}
